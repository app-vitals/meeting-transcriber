...
2. Records two audio streams simultaneously:
   ...
   - **Speaker** — other participants via ScreenCaptureKit
...
Speaker audio is captured via **ScreenCaptureKit** — no extra software needed. Grant **Screen Recording** permission when prompted on first launch. Requires macOS 13 (Ventura) or later.
